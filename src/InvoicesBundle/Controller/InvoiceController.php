			...
			// }
				...
				$form->handleRequest($request);
			       ...
			       if ($form->isSubmitted() && $form->isValid()) {
					   ...
					   //refresh adding succes/error info
					   //return $this->redirectToRoute('invoice_new',array('id'=>$insertedInvoiceId));
					   ...
					   $invoiceEntity = $invoiceDbEntry !=null ? $invoiceDbEntry : $invoiceEntity;
			       }
